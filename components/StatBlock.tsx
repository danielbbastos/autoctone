/* Takes a whole `Stat` (not loose props) so it can only render numbers that
 * exist — cited — in lib/narrative.ts. Kept below the section heading in size. */
    ...
    <figure className="border-l-2 border-cork/50 pl-5">
      <div className="flex items-baseline gap-2">
        <span className="font-display text-4xl font-semibold tabular-nums leading-none text-emerald-50 sm:text-5xl">
          {pick(locale, stat.value, stat.valueEn)}
        </span>
